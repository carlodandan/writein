  ...
  const windowsPackages = [
    {
      ...
      file: 'write-in_4.1.0_x64-setup.exe',
      size: '~12 MB',
      recommended: true,
      href: 'https://github.com/carlodandan/writein/releases/download/v4.1.0/write-in_4.1.0_x64-setup.exe',
    },
    {
      ...
      file: 'write-in_4.1.0_x64_en-US.msi',
      size: '~14 MB',
      recommended: false,
      href: 'https://github.com/carlodandan/writein/releases/download/v4.1.0/write-in_4.1.0_x64_en-US.msi',
    },
  ];
